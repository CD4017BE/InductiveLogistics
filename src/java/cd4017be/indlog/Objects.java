...
public class Objects {
	...
	public static final ItemItemPropertyFilter property_filter = null;
	public static final ItemNameFilter name_filter = null;
	...
	public static void registerItems(RegistryEvent.Register<Item> ev) {
		...
		ev.getRegistry().registerAll(
			...
			new ItemItemPropertyFilter("property_filter").setCreativeTab(tabIndLog),
			new ItemNameFilter("name_filter").setCreativeTab(tabIndLog),
